...
# SSD RESNET - VOC0712 - LAYER WISE PRUNING
...
gammas = np.arange(0.2, 2.2, 0.2) # Parameters whose value is less than gamma * std_dev in each layer will be pruned
...
for gamma in gammas:
    ...
    pruned_net = '{}_{}_stddev_{}%_layer_wise_pruned.caffemodel'.format(os.path.splitext(basename)[0], gamma, int(prune_percent))
