...
usage = '''
Usage:
	score_coco_resnet.py <prune_percent>
'''
...
model_name = "ResNet_coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet/coco/{}_score".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/coco/{}_score".format(job_name)
...
with open(job_file, 'w') as f:
  ...
  if solver_param['solver_mode'] == P.Solver.GPU:
    f.write('--gpu {} 2>&1 | tee {}/{}_{}%_pruned.log\n'.format(gpus, job_dir, model_name, prune_percent))
  else:
