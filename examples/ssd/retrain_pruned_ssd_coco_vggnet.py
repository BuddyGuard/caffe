...
usage = '''
Usage:
        python retrain_pruned_ssd_coco_vggnet.py <prune-tpye> <prune-percent> <pruned-model>
                                or
        python retrain_pruned_ssd_coco_vggnet.py <prune-type> <prune-percent> <std-dev> <pruned-model>
...
def AddExtraLayers(net, use_batchnorm=True, lr_mult=1, prune_mask=False):
    use_relu = True
    ...
    ConvBNLayer(net, from_layer, out_layer, use_batchnorm, use_relu, 256, 1, 0, 1,
        lr_mult=lr_mult, prune_mask=prune_mask)
...
VGGNetBody(net, from_layer='data', fully_conv=True, reduced=True, dilated=True,
    dropout=False, prune_mask=prune_mask)

AddExtraLayers(net, use_batchnorm, lr_mult=lr_mult, prune_mask=prune_mask)

mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=mbox_source_layers,
        use_batchnorm=use_batchnorm, min_sizes=min_sizes, max_sizes=max_sizes,
        aspect_ratios=aspect_ratios, steps=steps, normalizations=normalizations,
        num_classes=num_classes, share_location=share_location, flip=flip, clip=clip,
        prior_variance=prior_variance, kernel_size=3, pad=1, lr_mult=lr_mult, prune_mask=prune_mask)
