...
usage = '''
Usage:
        python retrain_pruned_ssd_pascal_cdp_vggnet.py <prune-tpye> <prune-percent> <pruned-model>
                                or
        python retrain_pruned_ssd_pascal_cdp_vggnet.py <prune-type> <prune-percent> <std-dev> <pruned-model>
...
save_dir = "models/VGGNet/VOC0712CDP/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/VOC0712CDP/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/VOC0712CDP/{}".format(job_name)
