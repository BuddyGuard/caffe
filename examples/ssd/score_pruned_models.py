...
# SSD VGGNet - COCO - LAYER INDEPENDENT PRUNED - RETRAINED 15K - CLUSTERED 256
#clustered_models_path = os.path.join(caffe_root, 'models/VGGNet/coco/Layer_Independent_Pruned_Retrained_Clustered_Models')
#original_model_name = os.path.join(caffe_root, 'models/VGGNet/coco/SSD_300x300/VGG_coco_SSD_300x300_iter_400000.caffemodel')
...
# SSD VGGNet - COCO - LAYER INDEPENDENT PRUNED - RETRAINED 15K - CLUSTERED 256 - DECOMPRESSED
decompressed_models_path = os.path.join(caffe_root, 'models/VGGNet/coco/Layer_Independent_Pruned_Retrained_Clustered_Decompressed_Models')
original_model_name = os.path.join(caffe_root, 'models/VGGNet/coco/SSD_300x300/VGG_coco_SSD_300x300_iter_400000.caffemodel')
scoring_script = 'examples/ssd/score_pruned_ssd_coco_vggnet.py'
itr = 15000
prune_type = 'layer_indep'
...
for model in models:
    if '.caffemodel' in model:
        ...
        if prune and prune_type == 'layer_indep':
            ...
            cmd = 'python {} {} {} {} {}'.format(scoring_script, 'cluster', 'layer_indep', prune_percent, 'clustered')
